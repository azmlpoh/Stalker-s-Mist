...
vec2 iResolution = openfl_TextureSize;
	...
	float amplitude = (glitchAmplitude == 0.0 && glitchNarrowness == 0.0 && glitchBlockiness == 0.0 && glitchMinimizer == 0.0) ? 0.2 : glitchAmplitude;
    float narrowness = (glitchAmplitude == 0.0 && glitchNarrowness == 0.0 && glitchBlockiness == 0.0 && glitchMinimizer == 0.0) ? 4.0 : glitchNarrowness;
    float blockiness = (glitchAmplitude == 0.0 && glitchNarrowness == 0.0 && glitchBlockiness == 0.0 && glitchMinimizer == 0.0) ? 2.0 : glitchBlockiness;
    float minimizer = (glitchAmplitude == 0.0 && glitchNarrowness == 0.0 && glitchBlockiness == 0.0 && glitchMinimizer == 0.0) ? 5.0 : glitchMinimizer;
